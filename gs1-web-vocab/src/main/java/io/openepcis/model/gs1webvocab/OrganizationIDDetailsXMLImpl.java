...
import io.openepcis.model.interfaces.OrganizationIDDetails;
import jakarta.xml.bind.annotation.*;

/**
 * Government bodies, trade organisations, and other parties issue identifiers that are associated
 * to legal entities and/or functions. Linking these identifiers to GLN and one another supports
 * consolidating records, mapping related, collaborative identifiers, enhances search ability and
 * enables more efficient transitions between identifiers. This class provides a mechanism for
 * connecting and sharing party identifiers.
 *
 * <p>Java class for OrganizationID_Details complex type.
 *
...
public class OrganizationIDDetailsXMLImpl implements OrganizationIDDetails {
   ...
   *
   * @return possible object is {@link OrganizationIDType }
   */
  @Override
   ...
   *
   * @param value allowed object is {@link OrganizationIDType }
   */
  @Override
