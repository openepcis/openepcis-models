...
/**
 * A grouping of properties related to the yield of a food or beverage product according to a
 * specified type of preparation.
 *
 * <p>Java class for ProductYieldDetails complex type.
 *
...
@XmlType(
    name = "ProductYieldDetails",
    propOrder = {"productYield", "productYieldType", "productYieldVariationPercentage"})
public class ProductYieldDetailsXMLImpl implements ProductYieldDetails<QuantitativeValueXMLImpl> {
   ...
   *
   * @return possible object is {@link ProductYieldTypeCode }
   */
  @Override
   ...
   *
   * @param value allowed object is {@link ProductYieldTypeCode }
   */
  @Override
