...
/**
 * Class used during the Unmarshalling (XML -> Object) and Marshalling (Object -> XML) for the
 * "CertificationInfo" field during the XML reading/writing. certificationInfo can be String or
 * List<String> hence based on the value handle accordingly. Ex: "certificationInfo":
 * "https://example.com/certificate/1" or "certificationInfo": [ ""certificationInfo":
 * "https://example.com/certificate/1", "https://example.com/certificate/1"]
 */
public class CertificationInfoXmlAdapter extends XmlAdapter<Object, Object> {
  ...
  public Object unmarshal(Object v) {
    if (v instanceof Element element) {
      ...
      // Todo we may need to support the complete list in EPCIS 2.1 instead of just 1 element in XML
      // as per EPCIS 2.0
      /*
  ...
  // During the writing of XML handle either simple String or List<String> and write
  // certificationInfo field
  @Override
