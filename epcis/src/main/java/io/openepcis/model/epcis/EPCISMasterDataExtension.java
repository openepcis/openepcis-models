...
@XmlType(name = "EPCISMasterDataBodyExtensionType", namespace = "urn:epcglobal:epcis-masterdata:xsd:2", propOrder = {"any"})
public class EPCISMasterDataExtension {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof EPCISMasterDataExtension)) return false;
    EPCISMasterDataExtension other = (EPCISMasterDataExtension) o;
  ...
  protected boolean canEqual(Object other) {
    return other instanceof EPCISMasterDataExtension;
  }
  ...
  public String toString() {
    return "EPCISMasterDataExtension(any=" + this.getAny() + ", otherAttributes=" + this.getOtherAttributes() + ")";
  }

  public EPCISMasterDataExtension() {
  }

  public EPCISMasterDataExtension(List<Object> any, Map<QName, String> otherAttributes) {
    this.any = any;
    this.otherAttributes = otherAttributes;
  }
}
